...
CREATE TYPE "public"."roles" AS ENUM('student', 'teacher', 'admin');--> statement-breakpoint
...
CREATE INDEX "verification_user_id_idx" ON "verification" USING btree ("identifier");--> statement-breakpoint
CREATE INDEX "subject_department_id_idx" ON "subjects" USING btree ("department_id");